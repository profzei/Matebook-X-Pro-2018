//
// Configuration data for other SSDTs in this repo:
// SSDT-PNLF, SSDT-PTSWAK
// Credit to Rehabman
//
...
DefinitionBlock ("", "SSDT", 2, "hack", "_RMCF", 0)
{
    ...
    Device (RMCF)
    {
        ...
        //  This fixes "auto restart" after shutdown when USB devices are plugged 
        //  into XHC on certain computers.
        //  0: does not affect _PTS behavior during shutdown
