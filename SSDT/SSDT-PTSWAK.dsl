    ...
    Method(_WAK, 1, NotSerialized) // _WAK: Wake
    {
        ...
        If (CondRefOf(\RMCF.DPTS))
        {
            If (\RMCF.DPTS)
            {
                ...
                If (CondRefOf (\_SB.PCI0.RP01.PXSX.HGOF)) { \_SB.PCI0.RP01.PXSX.HGOF () }
                If (CondRefOf (\_SB.PCI0.RP01._OFF)) { \_SB.PCI0.RP01._OFF () }
                */
            }
        }
