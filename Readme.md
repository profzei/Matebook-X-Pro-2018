...
## Bootloader Firmware
- Default bootloader: `OpenCore 0.7.3` [Official release](https://github.com/acidanthera/OpenCorePkg/releases). See more info in [Wiki section](https://github.com/profzei/Matebook-X-Pro-2018/wiki/Converting-from-Clover-to-OpenCore) about migration.
...
- Support macOS 10.14 ~ macOS 11.6
