...
#### This repo is currently compatible with macOS Big Sur, Catalina and OpenCore 0.6.6
...
## Bootloader Firmware
- Default bootloader: `OpenCore 0.6.6` [Official release](https://github.com/acidanthera/OpenCorePkg/releases). See more info in [Wiki section](https://github.com/profzei/Matebook-X-Pro-2018/wiki/Converting-from-Clover-to-OpenCore) about migration.
...
- Support macOS 10.14 ~ macOS 11.2
